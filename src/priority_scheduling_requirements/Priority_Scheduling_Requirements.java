package priority_scheduling_requirements;

public class Priority_Scheduling_Requirements {
	...
	public Priority_Scheduling_Requirements(int process_Number2, int[] burst_Time2, int[] process_OrderQueue2)
	{
	...
	public void Grant_Chart( )
	{
		...
		for( count_GrantChart = 1; count_GrantChart <= process_Number; count_GrantChart++ )
		{
			...
			for(int i = 1; i <= count_GrantChart; i++)
			{
				...
				sum_Of_Burst_Time = sum_Of_Burst_Time + burst_Time[temp];
				
			}

			
			System.out.printf("P%d", temp);
	...
	public void Times()
	{
		...
		for( int i = 1; i <= process_Number; i++ )
		{
			...
			for( int j = 1; j <= i; j++ )
			{
				...
				sum_Of_WaitingTime_2 = sum_Of_WaitingTime_2 + burst_Time[temp];
...
} //End of public class Priority_Scheduling_Requirements;